const data = [{
  pic: {
    value: require('./images/photos/photo_luck_1.jpg'),
    animateIn: 'fadeIn',
    animateOut: 'fadeOut'
  },
  des: {
  ...
  pic: {
    value: require('./images/photos/photo_luck_2.jpg'),
    animateIn: 'zoomIn',
    animateOut: 'zoomOut'
  },
  des: {
  ...
  pic: {
    value: require('./images/photos/photo_luck_3.jpg'),
    animateIn: 'rotateIn',
  ...
  pdt: [{
    value: require('./images/pendants/pdt12.gif'),
  ...
  pdt: [{
    value: require('./images/pendants/pdt30.gif'),
    animateIn: 'fadeIn',
    animateOut: 'fadeOut',
    style: {
      right: '5%',
  ...
  pdt: [{
    value: require('./images/pendants/pdt13.gif'),
    animateIn: 'fadeIn',
    animateOut: 'fadeOut',
    style: {
      left: '10%',
